...
describe('heuristicLabel', () => {
  describe('bot signals', () => {
    ...
    it('does NOT flag avgPredictedCount === 0 (demoted to embedding-only)', () => {
      const payload = makePayload({ features: { avgPredictedCount: 0, totalPoints: 50 } });
      payload.userAgent =
        'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
      const result = heuristicLabel(payload);
